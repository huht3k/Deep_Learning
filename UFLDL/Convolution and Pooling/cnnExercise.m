...
load('STL10Features.mat');   %%from save('STL10Features.mat', 'optTheta', 'ZCAWhite', 'meanPatch');
%% We use the features learned on 8x8 patches sampled from images from the STL-10 dataset in 
%% the earlier exercise on linear decoders for classifying images from a reduced STL-10 dataset 
%% applying  convolution and  pooling. 
%% The reduced STL-10 dataset comprises 64x64 images from 4 classes (airplane, car, cat, dog). 

% --------------------------------------------------------------------

% Display and check to see that the features look good
%% by Mr. Hu: W, b are W1, b1 acutally
...
disp('load stlTrainSubset.mat and load stlTestSubset.mat, done!!');
pause;
...
disp('train softmax using the pooled feature, done!!');
pause;
