...
for iteration = 1:200   
    ...
    weightMatrix = zeros(visibleSize, numFeatures);     %% 64 * 121
    % -------------------- YOUR CODE HERE --------------------
    % Instructions:
    ...
    weightMatrix = batchPatches * featureMatrix' / (gamma * batchNumPatches * eye(size(featureMatrix, 1)) ...
        + featureMatrix * featureMatrix');   %% close form
